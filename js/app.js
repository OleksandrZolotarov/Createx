(() => {
    ...
    function initSliders() {
        if (document.querySelector(".tutors__slider")) new swiper_core_Swiper(".tutors__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".tutors__swiper-button-prev",
                nextEl: ".tutors__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.4,
        ...
        if (document.querySelector(".other-courses__slider")) new swiper_core_Swiper(".other-courses__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            speed: 800,
            navigation: {
                prevEl: ".other-courses__swiper-button-prev",
                nextEl: ".other-courses__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".hr-blog__slider")) new swiper_core_Swiper(".hr-blog__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".hr-blog__swiper-button-prev",
                nextEl: ".hr-blog__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
        ...
        if (document.querySelector(".online-events__slider")) new swiper_core_Swiper(".online-events__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".online-events__swiper-button-prev",
                nextEl: ".online-events__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const toggleButtonsSignUp = document.querySelectorAll(".sign-up__show-pass");
        toggleButtonsSignUp.forEach((button => {
            button.addEventListener("click", (function() {
                const targetPasswordInput = button.closest(".sign-up__password-label-input").querySelector("input");
                if (targetPasswordInput) if (targetPasswordInput.type === "password") {
                    targetPasswordInput.type = "text";
                    button.classList.add("show-pass--open");
                } else {
                    targetPasswordInput.type = "password";
                    button.classList.remove("show-pass--open");
                }
            }));
        }));
        const signUpForm = document.querySelector(".sign-up__form");
        const passwordInputSignUp = document.getElementById("password-sign-up");
        const confirmPasswordInputSignUp = document.getElementById("confirm-password-sign-up");
        ...
        const toggleButtonsSignIn = document.querySelectorAll(".sign-in__show-pass");
        toggleButtonsSignIn.forEach((button => {
            button.addEventListener("click", (function() {
                const targetPasswordInput = button.closest(".sign-in__password-label-input").querySelector("input");
                if (targetPasswordInput) if (targetPasswordInput.type === "password") {
                    targetPasswordInput.type = "text";
                    button.classList.add("show-pass--open");
                } else {
        ...
        const toggleButtonsConfirmPass = document.querySelectorAll(".sign-up__confirm-pass");
        toggleButtonsConfirmPass.forEach((button => {
            button.addEventListener("click", (function() {
                const targetPasswordInput = button.closest(".sign-up__password-label-input").querySelector("input");
                if (targetPasswordInput) if (targetPasswordInput.type === "password") {
                    targetPasswordInput.type = "text";
        ...
        document.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".copyright-footer__button")) window.scrollTo({
                top: 0,
                left: 0,
                behavior: "smooth"
            });
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const buttons = document.querySelectorAll(".online-courses__filter-button");
        buttons.forEach((button => {
            button.addEventListener("click", (() => {
                buttons.forEach((btn => btn.classList.remove("_filter-button-active")));
                button.classList.add("_filter-button-active");
                button.getAttribute("data-filter");
            }));
        }));
    }));
    document.addEventListener("DOMContentLoaded", (() => {
        const buttons = document.querySelectorAll(".our-blog__filter-button");
        buttons.forEach((button => {
            button.addEventListener("click", (() => {
                buttons.forEach((btn => btn.classList.remove("our-blog-filter-button-active")));
                button.classList.add("our-blog-filter-button-active");
            }));
        }));
    }));
    document.addEventListener("DOMContentLoaded", (() => {
        const input = document.getElementById("our-events__input");
    ...
    document.querySelectorAll(".spollers__item").forEach((details => {
        const title = details.querySelector(".spollers__title");
        details.addEventListener("toggle", (() => {
            if (details.open) title.classList.add("is-open"); else title.classList.remove("is-open");
        }));
    }));
    document.addEventListener("DOMContentLoaded", (() => {
        const listButton = document.querySelector(".our-events__select-button._icon-list");
        const gridButton = document.querySelector(".our-events__select-button._icon-grid");
        const container = document.querySelector(".our-events__items");
        if (listButton && gridButton && container) {
            listButton.addEventListener("click", (() => {
                if (!container.classList.contains("our-events__items")) {
                    switchToListView();
                    setActiveButton(listButton);
                }
            }));
            gridButton.addEventListener("click", (() => {
                if (!container.classList.contains("our-events")) {
                    switchToGridView();
        ...
        function switchToListView() {
            container.innerHTML = `\n              <div class="our-events__items events-inline">\n                        <div class="events-inline__item events-inline__item--border">\n                            <div class="events-inline__item-date-time">\n                                <div class="events-inline__item-date">05</div>\n                                <div class="events-inline__item-month-time">\n                                    <div class="events-inline__item-month">August</div>\n                                    <div class="events-inline__item-time">11:00 – 14:00</div>\n                                </div>\n                            </div>\n                            <div class="events-inline__item-body">\n                                <h4 class="events-inline__item-title"> Formation of the organizational structure of the\n                                    company\n                                    in the face of uncertainty.</h4>\n                                <div class="events-inline__item-detail">Onine master-class</div>\n                            </div>\n                            <a href="#" class="events-inline__item-button button  button--white">View more</a>\n                        </div>\n                        <div class="events-inline__item  events-inline__item--border">\n                            <div class="events-inline__item-date-time">\n                                <div class="events-inline__item-date">24</div>\n                                <div class="events-inline__item-month-time">\n                                    <div class="events-inline__item-month">July</div>\n                                    <div class="events-inline__item-time">11:00 – 12:30</div>\n                                </div>\n                            </div>\n                            <div class="events-inline__item-body">\n                                <h4 class="events-inline__item-title"> Building a customer service department. Best\n                                    Practices.\n                                </h4>\n                                <div class="events-inline__item-detail">Onine lecture</div>\n                            </div>\n                            <a href="#" class="events-inline__item-button button  button--white">View more</a>\n                        </div>\n                        <div class="events-inline__item  events-inline__item--border">\n                            <div class="events-inline__item-date-time">\n                                <div class="events-inline__item-date">16</div>\n                                <div class="events-inline__item-month-time">\n                                    <div class="events-inline__item-month">July</div>\n                                    <div class="events-inline__item-time">10:00 – 13:00</div>\n                                </div>\n                            </div>\n                            <div class="events-inline__item-body">\n                                <h4 class="events-inline__item-title"> How to apply methods of speculative design in\n                                    practice.\n                                    Worldbuilding prototyping.</h4>\n                                <div class="events-inline__item-detail">Onine workshop</div>\n                            </div>\n                            <a href="#" class="events-inline__item-button button  button--white">View more</a>\n                        </div>\n                        <div class="events-inline__item events-inline__item--border">\n                            <div class="events-inline__item-date-time">\n                                <div class="events-inline__item-date">05</div>\n                                <div class="events-inline__item-month-time">\n                                    <div class="events-inline__item-month">August</div>\n                                    <div class="events-inline__item-time">11:00 – 14:00</div>\n                                </div>\n                            </div>\n                            <div class="events-inline__item-body">\n                                <h4 class="events-inline__item-title"> Formation of the organizational structure of the\n                                    company\n                                    in the face of uncertainty.</h4>\n                                <div class="events-inline__item-detail">Onine master-class</div>\n                            </div>\n                            <a href="#" class="events-inline__item-button button  button--white">View more</a>\n                        </div>\n                        <div class="events-inline__item events-inline__item--border">\n                            <div class="events-inline__item-date-time">\n                                <div class="events-inline__item-date">24</div>\n                                <div class="events-inline__item-month-time">\n                                    <div class="events-inline__item-month">July</div>\n                                    <div class="events-inline__item-time">11:00 – 12:30</div>\n                                </div>\n                            </div>\n                            <div class="events-inline__item-body">\n                                <h4 class="events-inline__item-title"> Building a customer service department. Best\n                                    Practices.\n                                </h4>\n                                <div class="events-inline__item-detail">Onine lecture</div>\n                            </div>\n                            <a href="#" class="events-inline__item-button button  button--white">View more</a>\n                        </div>\n                        <div class="events-inline__item events-inline__item--border">\n                            <div class="events-inline__item-date-time">\n                                <div class="events-inline__item-date">16</div>\n                                <div class="events-inline__item-month-time">\n                                    <div class="events-inline__item-month">July</div>\n                                    <div class="events-inline__item-time">10:00 – 13:00</div>\n                                </div>\n                            </div>\n                            <div class="events-inline__item-body">\n                                <h4 class="events-inline__item-title"> How to apply methods of speculative design in\n                                    practice.\n                                    Worldbuilding prototyping.</h4>\n                                <div class="events-inline__item-detail">Onine workshop</div>\n                            </div>\n                            <a href="#" class="events-inline__item-button button  button--white">View more</a>\n                        </div>\n                        <div class="events-inline__item  events-inline__item--border">\n                            <div class="events-inline__item-date-time">\n                                <div class="events-inline__item-date">05</div>\n                                <div class="events-inline__item-month-time">\n                                    <div class="events-inline__item-month">August</div>\n                                    <div class="events-inline__item-time">11:00 – 14:00</div>\n                                </div>\n                            </div>\n                            <div class="events-inline__item-body">\n                                <h4 class="events-inline__item-title"> Formation of the organizational structure of the\n                                    company\n                                    in the face of uncertainty.</h4>\n                                <div class="events-inline__item-detail">Onine master-class</div>\n                            </div>\n                            <a href="#" class="events-inline__item-button button  button--white">View more</a>\n                        </div>\n                        <div class="events-inline__item events-inline__item--border">\n                            <div class="events-inline__item-date-time">\n                                <div class="events-inline__item-date">24</div>\n                                <div class="events-inline__item-month-time">\n                                    <div class="events-inline__item-month">July</div>\n                                    <div class="events-inline__item-time">11:00 – 12:30</div>\n                                </div>\n                            </div>\n                            <div class="events-inline__item-body">\n                                <h4 class="events-inline__item-title"> Building a customer service department. Best\n                                    Practices.\n                                </h4>\n                                <div class="events-inline__item-detail">Onine lecture</div>\n                            </div>\n                            <a href="#" class="events-inline__item-button button  button--white">View more</a>\n                        </div>\n                        <div class="events-inline__item events-inline__item--border">\n                            <div class="events-inline__item-date-time">\n                                <div class="events-inline__item-date">16</div>\n                                <div class="events-inline__item-month-time">\n                                    <div class="events-inline__item-month">July</div>\n                                    <div class="events-inline__item-time">10:00 – 13:00</div>\n                                </div>\n                            </div>\n                            <div class="events-inline__item-body">\n                                <h4 class="events-inline__item-title"> How to apply methods of speculative design in\n                                    practice.\n                                    Worldbuilding prototyping.</h4>\n                                <div class="events-inline__item-detail">Onine workshop</div>\n                            </div>\n                            <a href="#" class="events-inline__item-button button  button--white">View more</a>\n                        </div>\n                    </div>\n        `;
            container.className = "our-events__items";
        }
        function switchToGridView() {
            container.innerHTML = ` \n                </article>\n<article class="events-grid__item">\n\t<div class="events-grid__date-time">\n\t\t<div class="events-grid__date">05 August</div>\n\t\t<div class="events-grid__time">11:00 – 14:00</div>\n\t</div>\n\t<div class="events-grid__body">\n\t\t<h4 class="events-grid__title">Formation of the organizational structure of the company in the face of\n\t\t\tuncertainty.</h4>\n\t\t<div class="events-grid__detail">Onine master-class</div>\n\t</div>\n\t<a href="#" class="events-grid__button button  button--white">View more</a>\n</article>\n\n</article>\n<article class="events-grid__item">\n\t<div class="events-grid__date-time">\n\t\t<div class="events-grid__date">24 July</div>\n\t\t<div class="events-grid__time">11:00 – 12:30</div>\n\t</div>\n\t<div class="events-grid__body">\n\t\t<h4 class="events-grid__title">Building a customer service department. Best Practices.</h4>\n\t\t<div class="events-grid__detail">Onine lecture</div>\n\t</div>\n\t<a href="#" class="events-grid__button button  button--white">View more</a>\n</article>\n</article>\n<article class="events-grid__item">\n\t<div class="events-grid__date-time">\n\t\t<div class="events-grid__date">16 July</div>\n\t\t<div class="events-grid__time">10:00 – 13:00</div>\n\t</div>\n\t<div class="events-grid__body">\n\t\t<h4 class="events-grid__title"> How to apply methods of speculative design in\n\t\t\tpractice.\n\t\t\tWorldbuilding prototyping.</h4>\n\t\t<div class="events-grid__detail">Onine workshop</div>\n\t</div>\n\t<a href="#" class="events-grid__button button  button--white">View more</a>\n</article>\n</article>\n<article class="events-grid__item">\n\t<div class="events-grid__date-time">\n\t\t<div class="events-grid__date">10 July</div>\n\t\t<div class="events-grid__time">09:00 – 14:00</div>\n\t</div>\n\t<div class="events-grid__body">\n\t\t<h4 class="events-grid__title">Find and evaluate: search and assessment tools for candidates.</h4>\n\t\t<div class="events-grid__detail">Onine workshop</div>\n\t</div>\n\t<a href="#" class="events-grid__button button  button--white">View more</a>\n</article>\n</article>\n<article class="events-grid__item">\n\t<div class="events-grid__date-time">\n\t\t<div class="events-grid__date">27 June</div>\n\t\t<div class="events-grid__time">10:00 – 13:00</div>\n\t</div>\n\t<div class="events-grid__body">\n\t\t<h4 class="events-grid__title"> How to apply methods of speculative design in\n\t\t\tpractice.\n\t\t\tWorldbuilding prototyping.</h4>\n\t\t<div class="events-grid__detail">Onine workshop</div>\n\t</div>\n\t<a href="#" class="events-grid__button button  button--white">View more</a>\n</article>\n</article>\n<article class="events-grid__item">\n\t<div class="events-grid__date-time">\n\t\t<div class="events-grid__date">15 June</div>\n\t\t<div class="events-grid__time">10:00 – 13:00</div>\n\t</div>\n\t<div class="events-grid__body">\n\t\t<h4 class="events-grid__title"> How to apply methods of speculative design in\n\t\t\tpractice.\n\t\t\tWorldbuilding prototyping.</h4>\n\t\t<div class="events-grid__detail">Onine workshop</div>\n\t</div>\n\t<a href="#" class="events-grid__button button  button--white">View more</a>\n</article>\n        `;
            container.className = "events-grid";
        }
        function setActiveButton(activeButton) {
            document.querySelectorAll(".our-events__select-button").forEach((button => {
                button.classList.remove("our-events__select-button--active");
            }));
            activeButton.classList.add("our-events__select-button--active");
        }
    }));
    const links = document.querySelectorAll(".menu__link");
    links.forEach((link => {
        if (link.href === window.location.href) link.classList.add("menu__link--active");
    }));
    window["FLS"] = true;
    isWebp();
    addTouchClass();
